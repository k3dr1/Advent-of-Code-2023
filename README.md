...
| Day 11    | 3/10         | Apparently can be done in O(n) since dimensions are completely independent when taking manhattan distance. My solution is O(n^2) but even that was enough to get the answer instantly, so pretty easy  | ...                                |
